...
For each component with zero copyrights, the tool searches every alternative origin registered against the component in Black Duck for copyright text (via the origins API).
